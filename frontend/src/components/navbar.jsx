...
export default function Navbar() {
  ...
  return (
    <div className="navbar bg-white shadow-md px-4 sm:px-8">
  ...
  <div className="flex items-end justify-center w-10 h-10 rounded-full 
    ...
    <ThemeToggle />
        ...
        {user && (
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="dropdown-content menu p-2 shadow bg-white rounded-box w-48 mt-2"
            >
              <li>
                <button
                  onClick={handleLogout}
                  className="flex items-center gap-2 text-red-600 hover:bg-red-50 px-4 py-3 rounded-lg"
                >
