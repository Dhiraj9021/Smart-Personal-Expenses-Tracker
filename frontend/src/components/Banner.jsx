...
export default function Banner() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      label: "Total Visits",
      description: "Counting every visit",
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-gray-50">
      {/* Background Elements */}
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center items-center px-6 lg:px-20 py-12 space-y-16">
        ...
        <div className="text-center max-w-3xl space-y-8">
          <div className="flex justify-center items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900">MyXpenso</h1>
          </div>
